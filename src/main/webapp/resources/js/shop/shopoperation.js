...
$(function() {
	...
	// 注册店铺
	var registerShopUrl = "/o2o/api/shopadmin/registershop";
	// 根据shopid获取店铺详情，用于修改店铺信息
	var shopInfoUrl = "/o2o/api/shopadmin/getshopbyshopid?shopId=" + shopId;
	// 修改店铺
	var modifyShopUrl = "/o2o/api/shopadmin/modifyshop";
