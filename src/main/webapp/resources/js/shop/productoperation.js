...
$(function() {
	...
	var infoUrl = '/o2o/api/shopadmin/getproductbyproductid?productId=' + productId;
	// 获取当前店铺设定的商品类别列表Url
	var categoryUrl = '/o2o/api/shopadmin/getproductcategorylist';
	...
	if (isEdit) {
		...
		// 编辑Url
		productPostUrl = '/o2o/api/shopadmin/modifyproduct';
	} else {
		// 为false，则初始化新增product页面
		getProductInitInfo();
		// 新增Url
		productPostUrl = '/o2o/api/shopadmin/addproduct';
	}
