...
public class LocalAuthDaoTest extends BaseTest {
    ...
    public void testQueryLocalByUserNameAndPwd() throws Exception {
        // 按照账号和密码查询用户信息
        LocalAuth localAuth = localAuthDao.queryLocalByUserNameAndPassword(userName, password);
    ...
    public void testUpdateLocalAuth() {
        ...
        int effectedNum = localAuthDao.updateLocalAuth(1L, userName, password, password + "new", currentTime);
        Assert.assertEquals(1, effectedNum);
        // 查询该平台账号的最新消息
        LocalAuth localAuth = localAuthDao.queryLocalByUserId(1L);
        // 输出新密码
